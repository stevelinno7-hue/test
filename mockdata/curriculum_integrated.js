        ...
        math: [
            {
                ...
                units: [
                    { name: "單元 1：整數的運算", tags: ["數學", "整數", "絕對值", "國七"], topics: ["負數與絕對值", "整數的加減", "整數的乘除", "指數與科學記號"] },
                    { name: "單元 2：分數的運算", tags: ["數學", "分數", "因數", "國七"], topics: ["因數與倍數", "最大公因數與最小公倍數", "分數的加減乘除", "指數律"] },
                    { name: "單元 3：一元一次方程式", tags: ["數學", "一元一次", "方程式", "國七"], topics: ["以符號代表數", "一元一次式的運算", "解一元一次方程式", "應用問題"] }
                ]
            },
            {
                id: "math_j2", name: "國七數學 (下)", stage: "junior_high", subject: "math", book: "Book 2",
                units: [
                    { name: "單元 1：二元一次聯立方程式", tags: ["數學", "二元一次", "聯立", "國七"], topics: ["二元一次方程式", "解聯立方程式(代入/加減)", "應用問題"] },
                    { name: "單元 2：直角坐標與圖形", tags: ["數學", "坐標", "圖形", "國七"], topics: ["直角坐標平面", "二元一次方程式的圖形"] },
                    { name: "單元 3：比與比例", tags: ["數學", "比例", "國七"], topics: ["比例式與連比例", "正比與反比"] },
                    { name: "單元 4：一元一次不等式", tags: ["數學", "不等式", "國七"], topics: ["不等式的解與圖示", "不等式的應用"] }
                ]
            },
            {
                id: "math_j3", name: "國八數學 (上)", stage: "junior_high", subject: "math", book: "Book 3",
                units: [
                    { name: "單元 1：乘法公式與多項式", tags: ["數學", "乘法公式", "多項式", "國八"], topics: ["乘法公式", "多項式的加減乘除"] },
                    { name: "單元 2：平方根與畢氏定理", tags: ["數學", "根號", "畢氏定理", "國八"], topics: ["平方根與近似值", "根式的運算", "畢氏定理"] },
                    { name: "單元 3：因式分解", tags: ["數學", "因式分解", "十字交乘", "國八"], topics: ["提公因式", "乘法公式因式分解", "十字交乘法"] }
                ]
            },
            {
                id: "math_j4", name: "國八數學 (下)", stage: "junior_high", subject: "math", book: "Book 4",
                units: [
                    { name: "單元 1：等差數列與級數", tags: ["數學", "數列", "級數", "國八"], topics: ["等差數列", "等差級數"] },
                    { name: "單元 2：幾何圖形與尺規作圖", tags: ["數學", "幾何", "圖形", "國八"], topics: ["平面圖形", "垂直、平分與線對稱", "尺規作圖"] },
                    { name: "單元 3：三角形的性質", tags: ["數學", "幾何", "內角和", "國八"], topics: ["三角形的內角與外角", "三角形的全等性質", "邊角不等等關係"] },
                    { name: "單元 4：平行與四邊形", tags: ["數學", "幾何", "平行", "國八"], topics: ["平行線截角性質", "平行四邊形與特殊四邊形"] }
                ]
            },
            {
                id: "math_j5", name: "國九數學 (上)", stage: "junior_high", subject: "math", book: "Book 5",
                units: [
                    { name: "單元 1：相似形", tags: ["數學", "相似形", "幾何", "國九"], topics: ["連比例", "相似三角形", "相似形的應用"] },
                    { name: "單元 2：圓形", tags: ["數學", "圓", "幾何", "國九"], topics: ["點、直線與圓的關係", "圓心角、圓周角與弦切角"] },
                    { name: "單元 3：幾何證明與三角形的心", tags: ["數學", "幾何", "證明", "國九"], topics: ["幾何推理證明", "三角形的外心、內心與重心"] }
                ]
            },
            {
                id: "math_j6", name: "國九數學 (下)", stage: "junior_high", subject: "math", book: "Book 6",
                units: [
                    { name: "單元 1：二次函數", tags: ["數學", "二次函數", "拋物線", "國九"], topics: ["二次函數的圖形(拋物線)", "配方法與頂點", "最大值與最小值"] },
                    { name: "單元 2：統計與機率", tags: ["數學", "統計", "機率", "國九"], topics: ["統計圖表與數據分析(四分位數/盒狀圖)", "機率入門"] },
                    { name: "單元 3：立體幾何圖形", tags: ["數學", "立體", "幾何", "國九"], topics: ["角柱與圓柱", "角錐與圓錐", "展開圖"] }
                ]
            },
            // Senior High
            {
                ...
                units: [
                    { name: "單元 1：數與式", tags: ["數學", "數與式", "絕對值", "高一"], topics: ["數系與絕對值", "算幾不等式", "指數與對數基本運算"] },
                    { name: "單元 2：直線與圓", tags: ["數學", "直線", "圓", "高一"], topics: ["直線方程式與斜率", "圓方程式", "直線與圓的關係"] },
                    { name: "單元 3：多項式函數", tags: ["數學", "多項式", "餘式定理", "高一"], topics: ["多項式的除法原理", "餘式定理與因式定理", "二次函數與不等式"] }
                ]
            },
            {
                id: "math_s2", name: "高一數學 (下)", stage: "high_school", subject: "math", book: "Book 2",
                units: [
                    { name: "單元 1：數列與級數", tags: ["數學", "數列", "級數", "高一"], topics: ["等差與等比", "Σ運算", "數學歸納法"] },
                    { name: "單元 2：排列組合", tags: ["數學", "排列", "組合", "高一"], topics: ["計數原理", "排列", "組合", "二項式定理"] },
                    { name: "單元 3：機率", tags: ["數學", "機率", "期望值", "高一"], topics: ["古典機率", "期望值"] },
                    { name: "單元 4：數據分析", tags: ["數學", "數據", "統計", "高一"], topics: ["一維數據分析(標準差)", "二維數據分析(相關係數/迴歸直線)"] }
                ]
            },
            {
                id: "math_s3a", name: "高二數學 A (上)", stage: "high_school", subject: "math", book: "Book 3A",
                units: [
                    { name: "單元 1：三角函數", tags: ["數學", "三角", "正弦", "高二"], topics: ["弧度量", "三角函數圖形", "和差角公式", "正餘弦定理"] },
                    { name: "單元 2：指數與對數函數", tags: ["數學", "指數", "對數", "高二"], topics: ["指數函數圖形", "對數函數圖形", "方程式與不等式"] },
                    { name: "單元 3：平面向量", tags: ["數學", "向量", "內積", "高二"], topics: ["向量運算", "內積", "柯西不等式", "面積與行列式"] }
                ]
            },
            {
                id: "math_s4a", name: "高二數學 A (下)", stage: "high_school", subject: "math", book: "Book 4A",
                units: [
                    { name: "單元 1：空間向量", tags: ["數學", "空間", "向量", "高二"], topics: ["空間坐標系", "空間向量運算", "外積", "平面方程式"] },
                    { name: "單元 2：空間中的直線與平面", tags: ["數學", "空間", "直線", "高二"], topics: ["直線方程式", "距離公式", "夾角"] },
                    { name: "單元 3：矩陣", tags: ["數學", "矩陣", "行列式", "高二"], topics: ["矩陣運算", "矩陣的乘法", "反方陣", "平面上的線性變換"] },
                    { name: "單元 4：二次曲線", tags: ["數學", "圓錐曲線", "高二"], topics: ["拋物線", "橢圓", "雙曲線"] }
                ]
            },
            {
                id: "math_s5a", name: "高三數學甲 (上)", stage: "high_school", subject: "math", book: "Book 5 (Calc)",
                units: [
                    { name: "單元 1：極限與函數", tags: ["數學", "極限", "連續", "高三"], topics: ["數列的極限", "函數的極限", "連續函數"] },
                    { name: "單元 2：微分", tags: ["數學", "微分", "導數", "高三"], topics: ["導數與導函數", "微分公式(連鎖律)", "微分應用(極值、切線、凹凸性)"] },
                    { name: "單元 3：積分", tags: ["數學", "積分", "定積分", "高三"], topics: ["黎曼和與定積分", "微積分基本定理", "積分應用(面積、體積)"] }
                ]
            },
            {
                id: "math_s6a", name: "高三數學甲 (下)", stage: "high_school", subject: "math", book: "Book 6",
                units: [
                    { name: "單元 1：複數與多項式方程式", tags: ["數學", "複數", "高三"], topics: ["複數極式", "棣美弗定理"] },
                    { name: "單元 2：隨機變數", tags: ["數學", "機率", "統計", "高三"], topics: ["隨機變數", "二項分佈", "幾何分佈", "常態分佈"] }
                ]
            }
        ],
        ...
        physics: [
            {
                ...
                units: [
                    { name: "單元 1：基本測量", tags: ["理化", "物理", "測量", "密度", "國八"], topics: ["長度與體積", "質量與密度", "估計值"] },
                    { name: "單元 2：波動與聲音", tags: ["理化", "物理", "波動", "聲音", "國八"], topics: ["波的性質", "聲波與樂音", "回聲"] },
                    { name: "單元 3：光", tags: ["理化", "物理", "光", "透鏡", "國八"], topics: ["光的反射與面鏡", "光的折射與透鏡", "色散與顏色"] },
                    { name: "單元 4：熱", tags: ["理化", "物理", "熱", "溫度", "國八"], topics: ["溫度與熱量", "熱的傳播(傳導/對流/輻射)", "比熱"] }
                ]
            },
            {
                id: "phy_j5", name: "國九理化 (上-物理篇)", stage: "junior_high", subject: "physics", book: "Book 5",
                units: [
                    { name: "單元 1：直線運動", tags: ["理化", "物理", "運動學", "國九"], topics: ["位置與位移", "速度與速率", "加速度"] },
                    { name: "單元 2：力與運動", tags: ["理化", "物理", "力", "牛頓定律", "國九"], topics: ["牛頓第一運動定律", "牛頓第二運動定律", "牛頓第三運動定律", "圓周運動"] },
                    { name: "單元 3：功與能", tags: ["理化", "物理", "功", "能量", "國九"], topics: ["功與功率", "動能與位能", "力學能守恆", "簡單機械"] }
                ]
            },
            {
                id: "phy_j6", name: "國九理化 (下-物理篇)", stage: "junior_high", subject: "physics", book: "Book 6",
                units: [
                    { name: "單元 1：電與生活", tags: ["理化", "物理", "電學", "國九"], topics: ["電流與電壓", "電阻與歐姆定律", "電路連接"] },
                    { name: "單元 2：電流磁效應", tags: ["理化", "物理", "電磁", "國九"], topics: ["磁鐵與磁場", "電流磁效應", "電磁鐵"] },
                    { name: "單元 3：電磁感應", tags: ["理化", "物理", "電磁", "國九"], topics: ["法拉第定律", "發電機與馬達", "變壓器"] }
                ]
            },
            {
        ...
        chemistry: [
            {
                ...
                units: [
                    { name: "單元 1：物質的組成", tags: ["理化", "化學", "原子", "週期表", "國八"], topics: ["元素與化合物", "原子結構", "週期表"] },
                    { name: "單元 2：化學反應", tags: ["理化", "化學", "化學反應", "莫耳數", "國八"], topics: ["化學式", "化學反應式", "原子量與分子量", "莫耳數"] },
                    { name: "單元 3：常見的化學反應", tags: ["理化", "化學", "氧化還原", "酸鹼", "國八"], topics: ["氧化與還原", "酸鹼定義", "pH值", "酸鹼中和"] },
                    { name: "單元 4：有機化合物", tags: ["理化", "化學", "有機", "國八"], topics: ["烴類", "醇/酸/酯", "聚合物", "肥皂與清潔劑"] }
                ]
            },
            {
        ...
        earth: [
            {
                ...
                units: [
                    { name: "單元 1：變動的地球", tags: ["地科", "板塊", "地震", "國九"], topics: ["地球分層", "板塊構造", "地震與火山"] },
                    { name: "單元 2：地貌與岩石", tags: ["地科", "岩石", "風化", "國九"], topics: ["岩石循環", "沉積岩/火成岩/變質岩", "地質營力"] },
                    { name: "單元 3：天氣變化", tags: ["地科", "天氣", "氣象", "國九"], topics: ["大氣結構", "氣團與鋒面", "氣象觀測"] },
                    { name: "單元 4：天文", tags: ["地科", "天文", "宇宙", "國九"], topics: ["晝夜與四季", "月相", "日食月食", "潮汐", "太陽系"] }
                ]
            },
            {
        ...
        history: [
            {
                ...
                units: [
                    { name: "單元 1：史前與原住民", tags: ["歷史", "史前", "原住民", "國七"], topics: ["長濱文化", "南島語族"] },
                    { name: "單元 2：大航海時代", tags: ["歷史", "荷西", "明鄭", "國七"], topics: ["荷蘭統治", "鄭氏政權"] },
                    { name: "單元 3：清帝國時期(上)", tags: ["歷史", "清領", "開港", "國七"], topics: ["開港通商前", "渡台禁令", "漢番關係"] }
                ]
            },
            {
                id: "hist_j2", name: "國七歷史 (臺灣史-下)", stage: "junior_high", subject: "history", book: "Book 2",
                units: [
                    { name: "單元 1：清帝國時期(下)", tags: ["歷史", "清領", "現代化", "國七"], topics: ["開港通商後", "沈葆楨/劉銘傳"] },
                    { name: "單元 2：日治時期", tags: ["歷史", "日治", "國七"], topics: ["殖民統治體制", "皇民化運動", "經濟建設"] },
                    { name: "單元 3：戰後臺灣", tags: ["歷史", "戰後", "民主", "國七"], topics: ["二二八事件", "白色恐怖", "經濟奇蹟", "民主化"] }
                ]
            },
            {
                id: "hist_j3", name: "國八歷史 (東亞史-上)", stage: "junior_high", subject: "history", book: "Book 3",
                units: [
                    { name: "單元 1：商周至隋唐", tags: ["歷史", "中國史", "國八"], topics: ["封建與郡縣", "儒家思想", "絲路"] },
                    { name: "單元 2：宋元明清", tags: ["歷史", "中國史", "國八"], topics: ["科舉士大夫", "經濟重心南移", "天朝體制"] }
                ]
            },
            {
                id: "hist_j4", name: "國八歷史 (東亞史-下)", stage: "junior_high", subject: "history", book: "Book 4",
                units: [
                    { name: "單元 1：晚清變局", tags: ["歷史", "晚清", "國八"], topics: ["鴉片戰爭", "自強運動", "甲午戰爭"] },
                    { name: "單元 2：中華民國與共產中國", tags: ["歷史", "民國", "國八"], topics: ["辛亥革命", "五四運動", "國共內戰", "改革開放"] },
                    { name: "單元 3：日本與朝鮮半島", tags: ["歷史", "日本", "朝鮮", "國八"], topics: ["明治維新", "日本帝國主義", "韓戰"] }
                ]
            },
            {
                id: "hist_j5", name: "國九歷史 (世界史-上)", stage: "junior_high", subject: "history", book: "Book 5",
                units: [
                    { name: "單元 1：古文明", tags: ["歷史", "古文明", "國九"], topics: ["西亞", "埃及", "印度", "希臘", "羅馬"] },
                    { name: "單元 2：普世宗教", tags: ["歷史", "宗教", "國九"], topics: ["基督教", "伊斯蘭教", "佛教"] },
                    { name: "單元 3：近代歐洲興起", tags: ["歷史", "歐洲", "國九"], topics: ["文藝復興", "宗教改革", "地理大發現"] }
                ]
            },
            {
                id: "hist_j6", name: "國九歷史 (世界史-下)", stage: "junior_high", subject: "history", book: "Book 6",
                units: [
                    { name: "單元 1：革命時代", tags: ["歷史", "革命", "國九"], topics: ["科學革命", "啟蒙運動", "工業革命", "法國大革命"] },
                    { name: "單元 2：帝國主義與戰爭", tags: ["歷史", "戰爭", "國九"], topics: ["新帝國主義", "一次大戰", "二次大戰"] },
                    { name: "單元 3：戰後世界", tags: ["歷史", "戰後", "國九"], topics: ["冷戰", "區域統合", "全球化"] }
                ]
            },
            {
