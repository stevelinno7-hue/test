(function(global){
    ...
    function init() {
        ...
        combinations.forEach(combo => {
            ...
            if (pool.length > 0) {
                ...
                G.registerTemplate(`chi_def_${grade}_${topic}`, (ctx, rnd) => {
                    console.log(`🔨 [Debug] 生成題目中: ${grade} ${topic}`); // 加入生成 Log
        ...
        console.log(`🎉 國文題庫 (V7.4 Meta修復版) 已載入！註冊 ${combinations.size * 2} 個模板。`);
    }
